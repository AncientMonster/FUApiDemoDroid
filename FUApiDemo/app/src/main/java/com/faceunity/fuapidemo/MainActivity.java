...
public class MainActivity extends ListActivity {
    ...
    private static final String[][] EXAMPLES = {
            { "fuDualInputToTexture",
              "示例：输入摄像头nv21格式内容和surface texture，输出添加美颜和道具后的texture",
              "FUDualInputToTextureExampleActivity"},
            { "fuRenderToNV21Image",
              "示例：输入摄像头nv21格式内容，输出添加美颜和道具后的nv21格式内容",
    ...
    private List<Map<String, Object>> createActivityList() {
        ...
        for (String[] example : EXAMPLES) {
            ...
            try {
                Class cls = Class.forName("com.faceunity.fuapidemo." + example[2]);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        //Meizu behaves wired in requestPermission,just ignore
